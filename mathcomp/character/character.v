...
Proof. apply: (big_morph (fun repr => @cfRepr _ (mx_repr_of_repr repr)) cfRepr_dadd cfRepr0). Qed.
...
Qed.
Canonical lin_char_mulrPred := MulrPred (GRing.divr_closedM linear_char_divr).
...
Lemma cfBigdprodKabelian Iphi (phi : forall i : I, 'CF(A i) := fun i => 'chi_(Iphi i)) :
